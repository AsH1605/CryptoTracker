...
fun LineChart(
    ...
    val seletedDataPOintIndex = remember(selectedDataPoint) {
...
//        )
        ...
        xLabelTextLayoutResults.forEachIndexed{index, result ->
            ...
            drawText(
                ...
                color = if (index == seletedDataPOintIndex){
                    style.selectedColor
                }else{
            ...
            if(showHelperLines){
                drawLine(
                    ...
                    strokeWidth = if (index == seletedDataPOintIndex){
                        style.helperLineThicknessPx * 1.5f
                    }else{
                        style.helperLineThicknessPx
                    }
                )
            }
            if(seletedDataPOintIndex == index){
                ...
                val textPositionX = if(seletedDataPOintIndex == visibleDataPointsIndices.last){
        ...
        val remainingHeightForLabels = labelViewPortHeightPx - heightRequiredForTheLabels
